...
public class AdminServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			System.out.println("in AdminServlet 1");
			session = request.getSession();
			if (session.isNew()) {
				redirectToLogin(request, response);
			} else {
				System.out.println("in AdminServlet 2");
				Integer personId = (Integer) session.getAttribute("UserID");
				// get patient details
				...
				System.out.println("in AdminServlet 3");
				...
				System.out.println("in AdminServlet 4");
