...
public class Login extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		case 1:
			...
			System.out.println("hello abhishek1");
			break;
		case 2:
			// person is doctor
			session = request.getSession();
		...
		case 4:
			...
			session.setAttribute("CreateTime", createTime);
			session.setAttribute("LastAccess", createTime);
			request.getRequestDispatcher("LabPersonServlet").forward(request, response);
			break;
		case 5:
			...
			session.setAttribute("CreateTime", createTime);
			session.setAttribute("LastAccess", createTime);
			request.getRequestDispatcher("ReceptionistServlet").forward(request, response);
			break;
		default:
