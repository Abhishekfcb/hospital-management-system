...
public class BookAppointment extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (session.isNew()) {
			...
			Patient patient = new DatabaseHelper().getPatient((Integer) session.getAttribute("UserID"));
			...
			if (status > 0) {
				...
				System.out.println("in Book Appointment before");
				rs = request.getRequestDispatcher("PatientServlet");
				System.out.println("in Book Appointment after");
