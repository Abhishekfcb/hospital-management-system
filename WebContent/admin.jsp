...
<%  
		if(request.getAttribute("admin")==null || request.getAttribute("doctors")==null 
			...
			System.out.println("this is Patients size:"+patients.size());
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="AdminServlet">Hospital Management System</a>
			</div>
		...
		<div class="row">
					...
					<thead>
					 ...
					 <tbody>
					  <% for(int i=0; i<patients.size(); i++){
						  ...
						  %>
					  <tr>
					  	 <%System.out.println("inside admin.jsp 1"); %>
						<td><%= person.getId() %></td>
					       <%System.out.println("inside admin.jsp 2"); %>
		                ...
		                <%System.out.println("inside admin.jsp 4"); %>
		 ...
		 <div class="col-sm-9 col-sm-offset-3 main" id="doctors" style="display: none;">
				<table class="table table-striped table-hover">
					<thead>
					  <tr>
					   <%System.out.println("inside admin.jsp 3"); %>
					    <th>Id</th>
					    <th>username</th>
					    <th>First name</th>
					    <th>last name</th>
